...
function draw() {
  //Draw sky
  background((sky.fill.r -= 0.15), (sky.fill.g -= 0.15), (sky.fill.b -= 0.15));
  ...
  ellipse(
    (mrFurious.x += random(-mrFurious.rage, mrFurious.rage)),
    (mrFurious.y += random(-mrFurious.rage, mrFurious.rage)),
    mrFurious.size,
  );
  pop();
  ...
  ellipse(
    ...
    (bird.position.y -= bird.speed * 0.25),
    bird.size.w,
    bird.size.h,
  );
